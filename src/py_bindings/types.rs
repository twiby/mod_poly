...
impl Complex {
    ...
    pub fn new(r: f64, i: f64) -> PyResult<Self> {
        Ok(Self {
            val: complex::Complex::<f64>::new(r, i),
        })
    }
    ...
    pub fn __getitem__(&self, n: usize) -> PyResult<f64> {
        match n {
            ...
            _ => Err(PyErr::new::<PyValueError, _>(format!(
                "Index too high for a complex number: {}",
                n
            ))),
        }
    }
...
impl Polynomial {
    ...
    pub fn new(coefs: Vec<Complex>, modulus: usize) -> PyResult<Self> {
        ...
        Ok(Self {
            val: polynomial::ModularArithmeticPolynomial::<complex::Complex<f64>>::new(
