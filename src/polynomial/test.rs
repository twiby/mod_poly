...
use crate::polynomial::{ModularArithmeticError, ModularArithmeticPolynomial, Polynomial};
...
fn polynomial_complex() {
    ...
    assert_eq!(
        poly_1.apply(Complex::<f32>::from(1.0)),
        Complex::new(2.0, 3.0)
    );
}
...
fn monomial() {
    ...
    assert_eq!(
        poly_1.apply(Complex::<f32>::from(2.0)),
        I_F32 * Complex::<f32>::from(4.0)
    );
}
...
fn add_polynomial() {
    ...
    assert_eq!(
        sum_1.apply(Complex::<f32>::from(1.0)),
        Complex::new(2.0, 3.0)
    );

    let sum_2 = &poly_2 + &poly_1;
    assert_eq!(
        sum_2.apply(Complex::<f32>::from(1.0)),
        Complex::new(2.0, 3.0)
    );
...
fn mult_mod_polynomial() {
    ...
    assert_eq!(
        mod_poly_1.apply(Complex::<f32>::from(1.0)),
        Complex::new(2.0, 3.0)
    );
    assert_eq!(
        mod_poly_2.apply(Complex::<f32>::from(1.0)),
        Complex::new(2.0, 3.0)
    );
